...
import {
  ...
  ArrowRight, ShieldCheck, Bell, Repeat2, Target, Map, Shield, TrendingDown,
} from 'lucide-react'
...
function buildCommands(
  ...
  return [
    ...
    },
    {
      id: 'deep-search',
      label: 'Research',
      description: 'AI-powered open-ended web research',
    ...
    },
    {
      id: 'search-engine',
      label: 'Search Engine',
      description: 'Keywords, SERP analysis, on-page audits & rank tracking',
      icon: <Search className="w-4 h-4" />,
      section: 'navigation',
      projectRequired: true,
      action: (pid) => router.push(`/projects/${pid}/search`),
    },
    {
      id: 'blog-brief',
      label: 'Blog Content Brief',
      description: 'SERP-grounded brief for long-form SEO content',
      icon: <FileText className="w-4 h-4" />,
      section: 'navigation',
      projectRequired: true,
      action: (pid) => router.push(`/projects/${pid}/search/blog-brief`),
    },
    {
      id: 'rank-tracker',
      label: 'Rank Tracker',
      description: 'Track Google positions for any URL + keyword pair',
      icon: <TrendingDown className="w-4 h-4" />,
      section: 'navigation',
      projectRequired: true,
      action: (pid) => router.push(`/projects/${pid}/search/rank-tracker`),
    },
    {
      id: 'repurpose',
      label: 'Repurpose Content',
      description: 'Generate variants or adapt across platforms',
      icon: <Repeat2 className="w-4 h-4" />,
      section: 'navigation',
      projectRequired: true,
      action: (pid) => router.push(`/projects/${pid}/content/repurpose`),
    },
    {
      id: 'campaigns',
      label: 'Campaigns',
      description: 'Multi-channel campaign briefs and content',
      icon: <Target className="w-4 h-4" />,
      section: 'navigation',
      projectRequired: true,
      action: (pid) => router.push(`/projects/${pid}/campaigns`),
    },
    {
      id: 'strategy',
      label: 'Strategy Hub',
      description: 'GTM, ICP, OKR, positioning and more',
      icon: <Map className="w-4 h-4" />,
      section: 'navigation',
      projectRequired: true,
      action: (pid) => router.push(`/projects/${pid}/strategy`),
    },
    {
      id: 'brand',
      label: 'Brand',
      description: 'Brand audit and health monitoring',
      icon: <Shield className="w-4 h-4" />,
      section: 'navigation',
      projectRequired: true,
      action: (pid) => router.push(`/projects/${pid}/brand`),
    },
    {
      id: 'emails',
      label: 'Email Studio',
    ...
    },
    {
      id: 'alerts',
      label: 'Alerts',
      description: 'Brand mentions and competitor change signals',
      icon: <Bell className="w-4 h-4" />,
      section: 'navigation',
      projectRequired: true,
      action: (pid) => router.push(`/projects/${pid}/intelligence/alerts`),
    },
    {
      id: 'voice-scorer',
      label: 'Voice Scorer',
